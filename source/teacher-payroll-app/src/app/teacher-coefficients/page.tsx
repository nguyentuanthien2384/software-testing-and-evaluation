...
export default function Page() {
  return <EntityCrudPage entityKey="degreeCoefficients" title="Thiết lập Hệ số giáo viên" description="Quản lý hệ số giáo viên theo bằng cấp và năm học; có thể sao chép trọn bộ từ năm liền trước." fields={fields as any} idPrefix="DCOEF" allowCopyPreviousYear />;
}
